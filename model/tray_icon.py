...
class TrayIcon(QSystemTrayIcon):
    ...
    def show_hide_window(self) -> None:
        ...
        Returns:
            None
        """
        self.sysLogger.debug("显示/隐藏主界面按钮被点击")
        ...
        self.sysLogger.debug("处理显示/隐藏主界面按钮点击事件完成")
    ...
    def iconClicked(self, reason) -> None:
        ...
        Returns:
            None
        """
        self.sysLogger.debug("系统托盘图标被点击")
        if reason in [2, 3]:
            self.parent().show()
            self.is_show_window = True
            self.show_hide_action.setText("隐藏主界面")
        ...
        self.sysLogger.debug("处理托盘图标点击事件完成")
    ...
    def quit(self) -> None:
        ...
        Returns:
            None
        """
        self.sysLogger.debug("退出按钮被点击")
        if self._main_window.close():
            self.setVisible(False)
        self.sysLogger.debug("处理退出按钮点击事件完成")
    ...
    def resetStyleSheet(self, theme_color: themeColor = settings.THEME_COLOR) -> None:
        ...
        Returns:
            None
        """
        self.sysLogger.debug("重制托盘图标菜单主题")
        self.menu.setStyleSheet(self.styleSheet(theme_color))
        self.sysLogger.debug("重制托盘图标菜单主题完成")
