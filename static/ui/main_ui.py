...
"}")
        ...
        self.verticalLayout_22 = QtWidgets.QVBoxLayout(self.backupButtonFrame)
        self.verticalLayout_22.setContentsMargins(10, 20, 10, 0)
        ...
        self.verticalLayout_22.addWidget(self.backupButton)
        self.verticalLayout_19.addWidget(self.backupButtonFrame)
        ...
        self.fileListTable.horizontalHeader().setDefaultSectionSize(800)
