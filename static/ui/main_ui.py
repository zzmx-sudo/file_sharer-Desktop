...
"}")
        ...
        self.clientFrame.setGeometry(QtCore.QRect(0, 0, 1001, 521))
        ...
        self.clientParamFeame = QtWidgets.QFrame(self.clientFrame)
        self.clientParamFeame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.clientParamFeame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.clientParamFeame.setObjectName("clientParamFeame")
        self.horizontalLayout_16 = QtWidgets.QHBoxLayout(self.clientParamFeame)
        self.horizontalLayout_16.setContentsMargins(10, 10, 10, 10)
        self.horizontalLayout_16.setSpacing(10)
        self.horizontalLayout_16.setObjectName("horizontalLayout_16")
        self.shareLinkLabel = QtWidgets.QLabel(self.clientParamFeame)
        self.shareLinkLabel.setObjectName("shareLinkLabel")
        self.horizontalLayout_16.addWidget(self.shareLinkLabel)
        self.shareLinkEdit = QtWidgets.QLineEdit(self.clientParamFeame)
        self.shareLinkEdit.setObjectName("shareLinkEdit")
        self.horizontalLayout_16.addWidget(self.shareLinkEdit)
        self.shareLinkButton = QtWidgets.QPushButton(self.clientParamFeame)
        self.shareLinkButton.setObjectName("shareLinkButton")
        self.horizontalLayout_16.addWidget(self.shareLinkButton)
        self.verticalLayout_20.addWidget(self.clientParamFeame)
